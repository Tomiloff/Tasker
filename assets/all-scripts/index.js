$(function () {
   ...
   //Обработка клика по .main-section для открытия tab и начала работы с tasks, также меняме фон у tab
